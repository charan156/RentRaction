        ...
        <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true">
                    ...
                    {{-- <li class="nav-item"><a class="nav-link link text-white display-4" href="/">Services</a></li>
                    <li class="nav-item"><a class="nav-link link text-white display-4" href="/">Owner</a></li>
                    <li class="nav-item"><a class="nav-link link text-white display-4" href="/">Tenant</a></li>
                    <li class="nav-item"><a class="nav-link link text-white display-4" href="/">Manager</a></li>
                    ...
                    @if (session()->has('userName')&& session('userName')==0 )
                        <li class="nav-item"><a class="nav-link link text-white display-4" href="/profile">Hello,{{session('userName')}}</a></li>
                        @else
                    @endif
                </ul>
