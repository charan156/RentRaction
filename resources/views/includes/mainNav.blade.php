    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true">
                ...
                <li class="nav-item"><a class="nav-link link text-white display-4" href="/services">Services</a></li>
            
                <li class="nav-item"><a class="nav-link link text-white display-4" href="/about-us">About us</a></li>
               
                @if (session()->has('userName')&& session('userName')==0 )
                    <li class="nav-item"><label class="nav-link link text-white display-4" href="">Hello,{{session('userName')}}</label></li>
                    @else
                @endif
            </ul>
