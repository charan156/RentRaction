    ...
    <div class="container">
        ...
        <div class="row justify-content-left content-row">
            <div class="media-container-column title col-12 col-lg-12 col-md-12">
                <h2 class="mbr-section-title mbr-fonts-style display-2">Available Properties</h2>
      <hr class="style-three">
            ...
            <div class="card p-3 col-12 col-md-6 col-lg-4">
                    <div class="card-wrapper">
                        <div class="card-img">
                        <img src="{{asset('storage/uploads/'.$item->img)}}" alt="House Image" title="" height="200 px">
                        </div>
                        <div class="card-box">
                    ...
                    <div class="mbr-section-btn text-center"><a href="{{ route('details', ['id'=>$item->id]) }}" class="btn btn-primary display-4">Apply</a></div>
                    </div>
                </div>
                @php
                     $count++
